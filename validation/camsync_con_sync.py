...
contra la base (camsync_sin_sync.csv, sin sync). Correr en la Pi con el servicio detenido:
    cd /usr/src/people-counter && python3 camsync_con_sync.py
Salida: camsync_con_sync.csv + stats + histograma.
"""
import csv
...
deltas = []
fh = open("/home/pi/bench/20260621/camsync_con_sync.csv", "w", newline="")
w = csv.writer(fh)
