...
Servicio detenido (cámaras libres). Correr en la Pi:
    cd /usr/src/people-counter && python3 camsync_sin_sync.py
Reporta % de pares dentro de 5 ms + p50/p95/máx. CSV: camsync_sin_sync.csv
"""
import sys
import time
import csv
...
cap.open()
deltas = []
fh = open('/home/pi/bench/20260621/camsync_sin_sync.csv', 'w', newline='')
w = csv.writer(fh)
