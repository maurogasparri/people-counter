...
-- vistos cruzar la counting zone / counts emitidos, ideal ≈ 1.0; >1.3 = fragmentación)
...
COMMENT ON COLUMN telemetry.track_stitching_ratio IS
    'Unique tracker IDs que cruzaron la counting zone / total counts emitidos hoy. '
...
COMMENT ON COLUMN telemetry.death_emit_count IS
    ...
    'tracks que cruzaron pero murieron dentro de la counting zone sin alcanzar el borde). '
